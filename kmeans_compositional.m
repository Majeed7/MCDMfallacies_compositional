function varargout = kmeans_compositional(X, k, varargin)
...
%   orientation.  KMEANS s an N-by-1 vector IDX containing the cluster
...
if issparse(X) || ~isfloat(X) || strcmp(distance,'cityblock') || ...
    ...
    varargout{2} = reverseLogRatio(varargout{2},revDim);
    return;
end
